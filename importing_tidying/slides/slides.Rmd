...
The entry `new_sp_m014` is actually four different variables.  

Use the `separate` function to pull them apart:
...
I've updated the `gapminder` data set available in the `gapminder` R data package by Jenny Bryan [here](https://github.com/jennybc/gapminder/).  Jenny provides instructions for recreating the data [here](https://github.com/jennybc/gapminder/tree/master/data-raw).
